    ...
    <Box id="SearchEvent" position={'relative'}>
      <Container className="SearchContainer"
        ...
        <Stack spacing={{ base: 10, md: 20 }}>
          ...
          <Stack className="CircleImg" direction={'row'} spacing={3} align={'center'}>
            <AvatarGroup>
              {avatars.map((avatar) => (
                <Avatar
                  key={avatar.name}
                  ...
                  _before={{
                    ...
                    bgGradient: 'linear(to-bl, blue.500,purple.400)',
                    position: 'absolute',
                    zIndex: -1,
                    top: 0,
                    left: 0,
            ...
            <Text fontFamily={'heading'} fontSize={{ base: '4xl', md: '4xl' }}>
              +
            </Text>
            <Flex
              align={'center'}
              ...
              color={'white'}
              rounded={'full'}
              minWidth={useBreakpointValue({ base: '60px', md: '60px' })}
              minHeight={useBreakpointValue({ base: '60px', md: '60px' })}
              position={'relative'}
              _before={{
                content: '""',
                width: 'full',
                ...
                rounded: 'full',
                transform: 'scale(1.125)',
                bgGradient: 'linear(to-bl, green.400,cyan.400)',
                position: 'absolute',
                zIndex: -1,
                top: 0,
                left: 0,
